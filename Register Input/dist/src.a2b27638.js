...
function validateForm(event) {
  ...
  var validate = document.getElementById("create-input-product").value;
...
function createRegister(event) {
  var createInputName = document.getElementById("create-input-product");
  var createInputPrice = document.getElementById("create-input-price");
